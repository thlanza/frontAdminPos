...
const BarChart3 = ({ data, mobile }) => {
  ...
  useEffect(() => {
    ...
    const margin = { top: 100, right: 0, bottom: 120, left: mobile ? 15 : 150 },
      ...
      height = mobile ? 450 - margin.top - margin.bottom : 600 - margin.top - margin.bottom;
  ...
  <svg width={mobile ? 290 : 700} height={mobile ? 450 : 600} id="barchart" ref={ref} />
  </div>);
};
